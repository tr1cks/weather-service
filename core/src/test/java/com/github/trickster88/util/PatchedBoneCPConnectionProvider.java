 ...
 *
 * For Hibernate 4.3.x support.
 *
 * @author wallacew
 */
public class PatchedBoneCPConnectionProvider implements ConnectionProvider,Configurable,Stoppable {
    /**
     * uid
     */
    ...
    /** Class logger. */
    private static Logger logger = LoggerFactory.getLogger(PatchedBoneCPConnectionProvider.class);
    ...
    public boolean isUnwrappableAs(Class unwrapType) {
        return ConnectionProvider.class.equals( unwrapType ) ||
                PatchedBoneCPConnectionProvider.class.isAssignableFrom( unwrapType );
    }
